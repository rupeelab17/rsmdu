# rsmdu Python Package

Python bindings for rsmdu, a Rust transpilation of pymdu (Python Urban Data Model).
...
cadastre = rsmdu.geometric.Cadastre(output_path="./output")
